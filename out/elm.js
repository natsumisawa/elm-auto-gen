...
var arowM$elm_form_decoder$Form$Decoder$array = function (d) {
...
var author$project$Main$update = F2(
	function (msg, model) {
		...
		var textFormList = _n0.textFormList;
		switch (msg.$) {
			case 'ChangeText':
				var input = msg.a;
				var index = msg.b;
				...
				if (_n3.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								errorMessageMaybe: author$project$Main$toErrorMessage(err)
							}),
						elm$core$Platform$Cmd$none);
				}
			case 'AddInput':
...
var author$project$Main$errorMessageView = function (errorMessageMaybe) {
	if (errorMessageMaybe.$ === 'Just') {
		var em = errorMessageMaybe.a;
		return A2(
			...
			mdgriffith$elm_ui$Element$text(em));
	} else {
...
var author$project$Main$view = function (model) {
	...
	var textJson = _n0.textJson;
	var textFormList = _n0.textFormList;
	var errorMessageMaybe = _n0.errorMessageMaybe;
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[mdgriffith$elm_ui$Element$centerX]),
					author$project$Main$convertButtonView)
				])));
};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Main.TextForm":{"args":[],"type":"{ text : String.String, index : Basics.Int, hasChild : Basics.Bool, parentIndexMaybe : Maybe.Maybe Basics.Int }"}},"unions":{"Main.Msg":{"args":[],"tags":{"ChangeText":["String.String","Basics.Int"],"ConvertText":[],"AddInput":["Basics.Int"],"AddNestedInput":["Main.TextForm"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));